...
import { ChevronRight, ChevronLeft, ChevronsRight, ChevronsLeft, FastForward, Rewind }  from 'lucide-react';
import { useCallback, useEffect, useState } from 'react';
import { tripleInputData } from './BaseInputProps';
import { ConfigurableInputProps } from './ConfigurableInput';

export default function DecCounterInput(props: ConfigurableInputProps) {
  const data = useQRScoutState(
    inputSelector<tripleInputData>(props.section, props.code),
  );
